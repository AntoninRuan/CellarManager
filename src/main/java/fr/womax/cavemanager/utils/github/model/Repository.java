...
import fr.womax.cavemanager.utils.github.model.commit.Commit;
import fr.womax.cavemanager.utils.github.model.issues.Issue;
import fr.womax.cavemanager.utils.github.model.issues.Label;
import fr.womax.cavemanager.utils.github.model.issues.Milestone;
...
public class Repository extends Authenticated {
    ...
    public static Repository fromJson(JsonObject object) throws ParseException {
        ...
        Date publishedAt = Test.DATE_FORMAT.parse(object.get("updated_at").getAsString());
        Date pushedAt = Test.DATE_FORMAT.parse(object.get("pushed_at").getAsString());
